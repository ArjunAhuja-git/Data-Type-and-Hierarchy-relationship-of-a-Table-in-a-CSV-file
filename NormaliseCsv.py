...
for i in xrange(1,len(ListOfCombinationsOfColumns)): #taking all 2^n-2 combinations of columns
	col_2 = []
...
ExtraTables = [tuple(set(x)) for x in ExtraTables]
ExtraTables = list(set(ExtraTables))
ExtraTables = [list(x) for x in ExtraTables]
print "Main Table after Normalistion------->",ColumnsLeft
print "Extra Tables after Normalisation---->",ExtraTables
print "Primary Key In Main Table----------->",primary_key
print
# print
# print "Now one-one relation from left to right is listed below:-"
# print
# for var in one_to_one_relation:
# 	print var[0],"----->",var[1]
# print
# print
# print "Now many-one relation from left to right is listed below:-"
# print
# for var in many_to_one_relation:
# 	print var[0],"----->",var[1]
